<?php
    ...
    if(get('code')) {
        ...
        setcookie("refresh_token", $token->refresh_token, time()+60*60*24*30);
    ...
    if(get('action') == 'logout') {
        ...
        if (isset($_COOKIE['refresh_token'])) setcookie("refresh_token", "", time() - 3600);
    ...
    if (get('action') == 'refresh' && isset($_COOKIE['refresh_token'])) {
        ...
        setcookie("refresh_token", $rtoken->refresh_token, time()+60*60*24*30);
